...
其结构图如图 1 所示。
### 图1
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q114135A2M3.gif)
## 2. 模式的实现
根据图 1 写出该模式的代码如下：
```
...
### 图2
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q11413554DT.gif)
...
```
程序的运行结果如图 3 所示。
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q114135422T9.gif)
# 模式的应用场景
工厂方法模式通常适用于以下场景。
...
## 图4
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q114135306120.gif)