...
其结构图如图 1 所示。
### 图1
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q1141H441X4.gif)
## 2. 模式的实现
图 1 给出了建造者（Builder）模式的主要结构，其相关类的代码如下。
### 2.1 产品角色：包含多个组成部件的复杂对象。
```
class Product
{
...
### 图2
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q1141H553419.gif)
程序代码如下：
```
package Builder;
import java.awt.*;
...
```
程序运行结果如图 3 所示。
![Image Text](http://c.biancheng.net/uploads/allimg/181114/3-1Q1141HK9195.jpg)
# 模式的应用场景
