...
类适配器模式的结构图如图 1 所示。
### 图1
![Image Text](http://c.biancheng.net/uploads/allimg/181115/3-1Q1151045351c.gif)
对象适配器模式的结构图如图 2 所示。
### 图2
![Image Text](http://c.biancheng.net/uploads/allimg/181115/3-1Q1151046105A.gif)
## 2. 模式的实现
类适配器模式的代码如下。
```
package adapter;
...
### 图3
![Image Text](http://c.biancheng.net/uploads/allimg/181115/3-1Q115104I22F.gif)
程序代码如下：
```
package adapter;
//目标：发动机
...
## 图4
![Image Text](http://c.biancheng.net/uploads/allimg/181115/3-1Q115104Q1604.gif)
程序代码如下： 
```
package adapter;
//目标接口
